...
class GetLatestWeeklyPulse {
  final AssessmentRepository _repo;
  const GetLatestWeeklyPulse(this._repo);

  Future<Either<AppFailure, WeeklyPulse?>> call(String userId) =>
      _repo.getLatestWeeklyPulse(userId);
}
